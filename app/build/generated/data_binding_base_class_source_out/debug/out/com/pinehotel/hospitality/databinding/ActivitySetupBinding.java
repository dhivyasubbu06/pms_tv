...
public final class ActivitySetupBinding implements ViewBinding {
  ...
  private ActivitySetupBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnSave,
      @NonNull EditText etRoomNumber) {
  ...
  public static ActivitySetupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySetupBinding((ConstraintLayout) rootView, btnSave, etRoomNumber);
    }
